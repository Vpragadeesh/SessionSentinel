...
Revision ID: e0cfc9362f4c
Revises: 
Create Date: 2026-08-13 10:33:46.665162
...
def upgrade() -> None:
    ...
    sa.Column('last_risk_update_at', sa.DateTime(timezone=True), nullable=True),
    ...
    sa.Column('guardrail_outcome', sa.String(length=30), nullable=True),
    sa.Column('guardrail_rule', sa.String(length=100), nullable=True),
